...
对于单频光，人眼是足够完备的，可以区分出任意不同频率的电磁波。然而对于广谱光，拥有三种感受器的人眼是不够完备的。有可能存在光谱分布不同，而人眼看到的色彩是一样（对应 LMS 空间中同一个点）的情况。这种现象叫做「异谱同色 ( metamerism ) 」。更多的思考，请看[这里](https://www.zhihu.com/question/20212687/answer/35119472)。
